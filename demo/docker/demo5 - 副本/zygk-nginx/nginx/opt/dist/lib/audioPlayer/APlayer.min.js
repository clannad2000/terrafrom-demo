!(function (e, t) {
  ...
  return (function (e) {
            ...
            },
            {
              ...
              value: function (e) {
                this.player.events.trigger('listadd', { audios: e }),
                  ...
                  e.map(function (e) {
                    return (
                      (e.name = e.name || e.title || '音频名称'),
                      (e.artist = e.artist || e.author || '作者'),
              ...
              value: function (e) {
                if (
                  ...
                  ;(this.player.template.pic.style.backgroundImage = t.cover
                    ...
                    this.player.template.title.setAttribute('title', t.name),
            ...
            },
            {
              ...
              value: function () {
                this.player.events.trigger('listclear'),
                  ...
                  this.player.template.title.setAttribute('title', ''),
                  ...
                  t = function (t) {
                    var n =
                      ((t.clientX || t.changedTouches[0].clientX) -
                        e.player.template.barWrap.getBoundingClientRect().left) /
                ...
                var t = function (t) {
                    var n =
                      ...
                      ((t.clientY || t.changedTouches[0].clientY) -
                        e.player.template.volumeBar.getBoundingClientRect().top) /
        ...
        (t.default = function (e) {
          ...
          return (
            ...
            e.audio.map(function (e) {
              return (
                (e.name = e.name || e.title || '音频名称'),
                (e.artist = e.artist || e.author || '音频作者'),
                (e.cover = e.cover || e.pic),
                (e.type = e.type || 'normal'),
                e
              )
                  ...
                  value: function () {
                    ...
                    this.on('error', function () {
                      e.list.audios.length > 1
                        ? (e.notice('发生音频播放错误，播放器将在 2 秒后播放上一曲！'),
                          (t = setTimeout(function () {
                            e.skipForward(), e.paused || e.play()
                          }, 2e3)))
                        : 1 === e.list.audios.length && e.notice('音频播放错误！')
                    }),
    ...
    function (e, t, n) {
      ...
      console.log(
        '\n %c APlayer v1.10.1 af84efb %c load completely \n',
        'padding:4px 0;color: #fadfa3;background: #030307;',
        'padding:4px 0;color: #fff;background:  rgb(29, 189, 69);'
      ),
        (t.default = r.default)
    }
  ]).default
